...
<div class="page-header">
    <h3 class="text-center">Got any question? Please feel free to contact Us.</h3>
</div>
                ...
                <form class="form-horizontal" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" id="message" name="message" placeholder="Enter your message for us here and we will get back to you." rows="7" required></textarea>
                            </div>
                        </div>
